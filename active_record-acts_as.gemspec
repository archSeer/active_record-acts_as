...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Simulate multi-table inheritance for activerecord models'
  spec.description   = 'Simulate multi-table inheritance for activerecord models using a plymorphic association'
  ...
  if RUBY_VERSION >= '2.2.3'
    ...
    spec.add_dependency 'activerecord', '>= 4.1.2', '<= 5'
  else
